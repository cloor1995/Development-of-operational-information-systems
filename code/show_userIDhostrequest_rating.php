...
?>
    ...
    <div class="container">
      ...
      <div class="col-12 col-md-6 col-lg-2">
        ...
        <!-- Back to profile --> 
        <a href="lookupprofilerequest.php?uid=<?php echo "$user_id"?>&pid=<?php echo "$party_id"?>" class="btn btn-danger my-2 p-2">Gehe wieder zum Profil</a>  
    </div>
            ...
            success:function(data)
            {
                ...
                if(data.review_data.length > 0)
                {
                    ...
                    for(var count = 0; count < data.review_data.length; count++)
                    {
                        ...
                        html += 'Party: '+ data.review_data[count].partyname;
                        ...
                        if(data.review_data[count].hostguest == 1)
                            ...
                            html += 'War bei '+data.review_data[count].firstname+ ' als ' +name+ ' vor Ort';
