...
<div class="container">
            <div class="row">
    	<h1 class="mt-5 mb-5" style ="color:white" >Möchtest du deine Erfahrung teilen?</h1>
    	<div class="card">
    		<div class="card-header" style="font-size:20px;" ><?php echo "$partyname"?> </div>
    		<div class="card-body">    
    			<div class="row">
      ...
      <div class="col-12 col-md-6 col-lg-2">
                <div class="card1">
                <div class="card-body">
                    <h5 class="card-title" style ="color:white"><?php echo "Host: <br> $firstname $lastname"?> </h5>
                    <hr>
                    <br>
                    <p class="card-text" style ="color:white"> Datum: <?php echo "$partydate"?></p>
                    <p class="card-text" style ="color:white"> Startzeit: <?php echo "$partytime"?> </p>
                    <p class="card-text" style ="color:white"> Teilnehmeranzahl: <?php echo "$partyparticipants"?> </p>
        ...
        <!-- Back to profile --> 
        <a href="show_parties_bygone.php" class="btn btn-danger my-2 p-2">Zurück zur Übersicht der vergangenen Partys</a>  
    </div>
            ...
            <form action="submit_userIDhost_rating.php" method="post">
	      	<div class="modal-body">
               ...
               <!-- Input data of the user_name -->
                ...
                <input type= "hidden" name ="hostguest" id="hostguest" value = 1>
                <input type= "hidden" name ="party_name" id="party_name" value = <?php echo $partyname ?>>
            ...
            success:function(data)
            {
                ...
                if(data.review_data.length > 0)
                {
                    ...
                    for(var count = 0; count < data.review_data.length; count++)
                    {
                        ...
                        html += data.review_data[count].user_name+ ' war bei  '+data.review_data[count].partyname + ' zu Gast ';
