               ...
               if ($result->num_rows > 0) {
                   if($row = $result->fetch_assoc()) {
                       ...
                       else
                       {
                        ...
                        echo "<td><a href='show_userIDhost_rating_request.php?uid=" . $USER_ID ."&pid=" . $party_id ."'class='btn btn-danger'>Bewertungen ansehen </a></td>";
                       }
                    }
                } else {
                    echo "0 ratings";
                ...
                <br>
                <br>
                <?php echo "<td><a href='requests.php'class='btn btn-danger'>Zurück zu meine Partyanfragen </a></td>";?>
                <br>
                <br>
