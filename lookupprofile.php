               ...
               if ($result->num_rows > 0) {
                   if($row = $result->fetch_assoc()) {
                       ...
                       else
                       {
                        ...
                        echo "<td><a href='show_userIDhost_rating.php?uid=" . $USER_ID ."&pid=" . $party_id ."'class='btn btn-danger'>Bewertungen ansehen </a></td>";
                       }
                    }
                } else {
                    echo "0 ratings";
                ...
                <br>
                <br>
                <?php echo "<td><a href='search_results_all.php'class='btn btn-danger'>Zurück zu allen Partys </a></td>";?>
                <br>
                <br>
