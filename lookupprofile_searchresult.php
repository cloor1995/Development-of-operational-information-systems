               ...
               <!-- <p class="card-text"> Gesamtbewertung: <?php// echo "$avgrating"?> von 5 Sternen</p> -->
                ...
                if ($result->num_rows > 0) {
                    if($row = $result->fetch_assoc()) {
                        ...
                        {
                            echo "<br>";   
                         echo "<td><a href='show_userIDhost_rating_searchresults.php?uid=" . $USER_ID ."&pid=" . $party_id ."'class='btn btn-danger'>Bewertungen ansehen </a></td>";
                        }
                     }
                 } else {
                     echo "0 ratings";
                ...
                <br>
                <br>
                <?php echo "<td><a href='search_results.php?location=".$location."&date=".$date."'class='btn btn-danger'>Zurück zu Suchergebnissen </a></td>";?>
                <br>
                <br>
