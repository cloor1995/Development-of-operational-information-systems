...
?>
    ...
    <div class="container">
            <div class="row">
    	<h1 class="mt-5 mb-5" >Wie hat dich die Community erlebt?</h1>
    	<div class="card">
    		<div class="card-header" style="font-size:20px;" >Dein Ergebnis: </div>
    		<div class="card-body">    
    			<div class="row">
      ...
      <div class="col-12 col-md-6 col-lg-2">
        ...
        <!-- Back to profile --> 
        <a href="profile.php" class="btn btn-danger my-2 p-2">Gehe wieder zum Profil</a>  
    </div>
...
$(document).ready(function(){
    ...
    $('#save_review').click(function(){
        ...
        if(user_name == '' || user_review == '' || hostguest == '')
        {
        ...
        else
        {
            ...
            $.ajax({
                url:"submit_myhost_rating.php", //a string containing the URL to which the request is sent.
                method:"POST", //HTTP method to use for the request
                data:{rating_data:rating_data, user_name:user_name, user_review:user_review, hostguest:hostguest}, //data to be sent to the server 
